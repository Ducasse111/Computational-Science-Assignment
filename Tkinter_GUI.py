...
class Application(tk.Frame):
    ...
    def create_graph(self, event=None):
        ...
        if self.activefile is not None:
            try:
                ...
                #self.image = self.img.resize((self.panel.winfo_width(), self.panel.winfo_height()), Image.ANTIALIAS)
    ...
    def on_resize(self, event):
        if self.raw_image is not None:
            #self.image = self.raw_image.resize((self.panel.winfo_width(), self.panel.winfo_height()), Image.ANTIALIAS)
            self.image = ImageTk.PhotoImage(self.img)
